...
if (isset($_POST['login_userid']) && (isset($_POST['login_password']))) {
    ...
    $result = tc_select(
        "empfullname, admin, time_admin", "employees",
    ...
    if     ($admin_auth == "1")      { $_SESSION['valid_user'] = $admin_username; }
    elseif ($time_admin_auth == "1") { $_SESSION['time_admin_valid_user'] = $admin_username; }
}
